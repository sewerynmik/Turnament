...
namespace Turnament.Controllers
{
    public class TournamentsController(AppDbContext context) : Controller
    {
        ...
        {
            ViewData["BracketTypeId"] = new SelectList(context.BracketTypes, "Id", "Id");
            ViewData["CreatorId"] = new SelectList(context.Users, "Id", "Id");
            ViewData["SportId"] = new SelectList(context.Sports, "Id", "Id");
            ViewData["WinnerTeamId"] = new SelectList(context.Teams, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,SportId,BracketTypeId,CreatorId,StartDate,EndDate,WinnerTeamId")] Tournament tournament)
        {
